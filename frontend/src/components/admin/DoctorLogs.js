...
const DoctorLogs = ({ logs, fetchLogs, loading }) => {
  ...
  const exportToCSV = () => {
    ...
    const headers = ["Timestamp", "Doctor Name", "Patient Name", "Action", "Status"];
    ...
    link.setAttribute("download", `doctor_logs_${new Date().toISOString().slice(0,10)}.csv`);
    ...
    <section className="admin-section">
      ...
      <div className="admin-content-area no-padding-bottom">
        <p className="section-description no-padding mb-2">
          Detailed record of doctor interactions, patient record access, and modifications.
        </p>
      </div>
              ...
              <tr>
                <td colSpan="5">
                   <div className="empty-state">
                    ...
                    <span>No doctor activity found</span>
                  </div>
                </td>
              </tr>
            )}
